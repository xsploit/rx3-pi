...
for deck,status in [(1,0x97),(2,0x99)]:
 for i in range(8):
  for key,note in [(f'hotcue_{i+1}_activate',i),('PioneerDDJFLX6.beatjumpPadPressed',0x20+i),(f'beatloop_{m.LOOP_SIZES[i]}_toggle',0x60+i)]:
...
with tempfile.NamedTemporaryFile(mode='w') as f:
 ...
 for deck,status in [(1,0x97),(2,0x99)]:
  for i in range(8):
   for note,mode in [(i,0x5040),(0x20+i,0x5043),(0x60+i,0x5041)]:
...
print('PASS both decks: eight hot cues, eight beat loops and eight beat-jump press/release mappings')
